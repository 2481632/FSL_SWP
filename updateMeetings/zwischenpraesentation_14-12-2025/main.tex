...
% \begin{frame}{Demo-Video | App-Funktionalität}
%     \centering
    
%     % Video im Hochformat korrekt skalieren
%     \includemedia[
%         width=0.35\textwidth,      % gut für Hochformat
%         height=0.75\textheight,    % hält Seitenverhältnis sauber
%         keepaspectratio,
%         activate=pageopen,
%         addresource=./img/demo.mp4,
%         flashvars={
%             source=./img/demo.mp4
%             &autoPlay=true
%             &loop=true
%         }
%     ]{\fbox{Video wird angezeigt, wenn PDF im Adobe Reader geöffnet wird}}{VPlayer.swf}

%     \vspace{0.5em}

%     {\footnotesize Demo der AR-Plane & Höhenmessung}
% \end{frame}
...
%     % Vorschau-Bild (erstellt automatisch aus dem Video)
%     \href{file:./img/demo.mp4}{\includegraphics{./img/screenshot_aktuellesProjekt.png}}
%     %\includegraphics[height=0.75\textheight,keepaspectratio]{./img/screenshot_aktuellesProjekt.png}

%     \vspace{0.4cm}
%     \small
%     Das Video kann über den folgenden Link abgespielt werden:

%     \vspace{0.2cm}
%     \href{run:./img/demo.mp4}{\beamergotobutton{Video starten}}
% \end{frame}

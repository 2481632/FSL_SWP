...
\begin{frame}{Implementation Status | Screenshot 2}
...
\begin{frame}{Demo-Video | App-Funktionalität}
    ...
    % Vorschau-Bild des Videos (z. B. erster Frame oder Screenshot)
    \includegraphics[height=0.75\textheight,keepaspectratio]{./img/screenshot_aktuellesProjekt.png}

    \href{https://github.com/2481632/FSL_SWP/blob/main/updateMeetings/zwischenpraesentation_14-12-2025/img/demo.mp4}{Link zum Demo-Video}
\end{frame}

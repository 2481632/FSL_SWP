...
\begin{frame}{Progress | Timeline part 1/2}

    \includegraphics[width=\textwidth,keepaspectratio]{./img/GantChart_1.png}

\end{frame}

\begin{frame}{Progress | Timeline part 2/2}

    \includegraphics[width=\textwidth,keepaspectratio]{./img/GantChart_2.png}
...
\begin{frame}{Conclusion}
      ...
      \begin{itemize}
        \item[\cmark] Funktionale AR-App für Android entwickelt
        \item[\cmark] Echtzeit-Visualisierung von Hochwasserdaten
        \item[\cmark] Integration echter APIs (Pegelonline, Open-Meteo)
        \item[\cmark] Intuitive Benutzeroberfläche mit AR-Overlay
      \end{itemize}
...
\begin{frame}{Reflection | Lessons Learnt}
  \begin{itemize}
    \item Unity
    \item AR
    \item Als Team zusammenarbeiten
  \end{itemize}
\end{frame}



\begin{frame}{Reflection |What worked well, what did not work?}
  \begin{itemize}
      \item [\cmark] Teamorganisation
      \item[\cmark] Entwicklung mit einer Mock API
      \item[\cmark] AR (Die vorgegebene Implementierung hat gut funktioniert)
      \item[\cmark] APIs 
      \item[{\textcolor{red}{$\times$}}] Unity Version Control
      \item[{\textcolor{red}{$\times$}}] Unity Editor
  \end{itemize}
\end{frame}

\begin{frame}{Reflection | What would we do different next time?}
  \begin{itemize}
    \item WebAR benutzen, wenn möglich
    \item Version Controll über Git
  \end{itemize}
\end{frame}
